CREATE DATABASE  IF NOT EXISTS `editora_rascunho` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `editora_rascunho`;
-- MySQL dump 10.13  Distrib 8.0.30, for Win64 (x86_64)
--
-- Host: localhost    Database: editora_rascunho
-- ------------------------------------------------------
...
CREATE TABLE `livrarias` (
  ...
  `departamentos_Id_Departamento` tinyint NOT NULL AUTO_INCREMENT,
...
-- Dump completed on 2022-10-03 22:42:36
